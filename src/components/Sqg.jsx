...
const Sqg = () => {
  ...
  const Search = () => {
    ...
    axios
      .post("http://admin.sqg.tewan.com/api/search/search_goods_list", data, {
        headers: {
  ...
  const getTaokouling = (itemid, title, itemendprice, itemprice) => {
    ...
    axios
      .post("http://admin.sqg.tewan.com/api/goods/create_tao_kouling", data, {
        headers: {
          "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
        },
      })
  ...
  return (
    <div>
      <Grid container spacing={3} alignItems="center">
        ...
        <Grid item>
          <Typography>淘口令：{taokouling}</Typography>
        </Grid>
        <Grid item>
          <Button
            className="btn"
            ...
            return (
              <Grid item xs={12} sm={6} md={3} lg={3} key={index}>
                ...
                <div>
                  {item.shoptype === "c" ? (
                    <img
                      src="/images/sqg/platform/taobao.png"
                      width="20px"
                      alt="淘宝"
                    />
                  ) : (
                    <img
                      src="/images/sqg/platform/tmall.png"
                      width="20px"
                      alt="天猫"
                    />
                  )}
